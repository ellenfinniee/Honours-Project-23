...
```{r readings from all 6 monitors (report fig 6.4)}
...
``` {r plotting full Lochee Road decomposition (report fig 6.5)}
...
``` {r plotting raw data and trend lines for NOx (report figs 6.6 and 6.7)}
...
``` {r plotting raw data and trend lines for PM_10 (report figs 6.8 and 6.9)}
